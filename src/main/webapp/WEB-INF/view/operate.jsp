...
<div class="easyui-accordion" data-options="region:'west'" style="width:248px;padding:0px; text-align:left;">
	<div title="协同数据" style="overflow:auto;padding:0px;"><ul id="help_tree" class="easyui-tree"></ul></div>
	<div title="我的数据" style="overflow:auto;padding:0px;">
	<ul id="mydata_tree" class="easyui-tree" animate="true" lines="true">
	</ul>
	</div>
	<div title="我的消息" selected="true" style="overflow:auto;padding:0px;"><ul id="msg_tree" class="easyui-tree"></ul></div>
</div>
